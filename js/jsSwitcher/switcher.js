...
jQuery(document).ready(function($) {
	...
	$(".lightblue").click(function() {
		$("#colors-style").attr("href", "css/colors/lightblue.css");
		$.cookie('layout_color', 'css/colors/lightblue.css');
		return false;
	});

	$(".winered").click(function() {
		$("#colors-style").attr("href", "css/colors/winered.css");
		$.cookie('layout_color', 'css/colors/winered.css');
		return false;
	});
